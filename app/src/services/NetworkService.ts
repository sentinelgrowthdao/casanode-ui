  ...
  public async checkInstallation(): Promise<NetworkInstallationCheck> 
{
  ...
  public async installDockerImage(): Promise<NetworkInstallConfiguration> 
{
    return await ApiService.installDockerImage();
  }

  public async installConfigs(): Promise<NetworkInstallConfiguration> 
{
    return await ApiService.installConfigs();
  }
