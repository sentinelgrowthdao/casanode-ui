...
import { IonCard, IonCardContent, IonCardHeader, IonCardTitle, IonContent, IonHeader, IonItem, IonLabel, IonNote, IonPage, UiInputField } from '@/ui';
				...
				<ion-card-content>
					<ion-item>
						...
						<UiInputField
							...
							:class="{
								'ui-input-field--touched': savingError === 'moniker',
								'ui-input-field--invalid': savingError === 'moniker'
							}">
						</UiInputField>
					</ion-item>
					<ion-item>
						<ion-label position="stacked">{{ $t('settings.type-label') }}</ion-label>
						<select v-model="nodeSettings.nodeType" class="ui-select-field">
							<option value="residential">{{ $t('settings.type-residential') }}</option>
							<option value="datacenter">{{ $t('settings.type-datacenter') }}</option>
						</select>
				...
				<ion-card-content>
					<ion-item>
						...
						<UiInputField
							...
							:class="{
								'ui-input-field--touched': savingError === 'nodeIp',
								'ui-input-field--invalid': savingError === 'nodeIp'
							}" />
					</ion-item>
					<ion-item>
						...
						<UiInputField
							...
							:class="{
								'ui-input-field--touched': savingError === 'nodePort',
								'ui-input-field--invalid': savingError === 'nodePort'
							}" />
					</ion-item>
					<ion-item v-if="nodeSettings.vpnType === 'wireguard'">
						...
						<UiInputField
							...
							:class="{
								'ui-input-field--touched': savingError === 'vpnPort',
								'ui-input-field--invalid': savingError === 'vpnPort'
							}" />
					</ion-item>
				...
				<ion-card-content>
					<ion-item>
						...
						<UiInputField
							...
							:class="{
								'ui-input-field--touched': savingError === 'maximumPeers',
								'ui-input-field--invalid': savingError === 'maximumPeers'
							}" />
					</ion-item>
					<ion-item>
						<ion-label position="stacked">{{ $t('settings.vpn-type-label') }}</ion-label>
						<select v-model="nodeSettings.vpnType" class="ui-select-field">
